...
This note outlined the development plan for DeFi Panda, a blockchain vault analytics application
focused on the ERC4626 standard.
...
- Frontend will constitute approximately 90% of the product
...
- Determine optimal approach for blockchain event collection - Ponder
- Implement frontend visualization components
- Develop data indexing and aggregation system
- Create comparison functionality for different vaults
